...
class update_file:
    ...
    async def upsra(self,
        ...
        if not islatest:
            dl_url = f"{git_proxy}https://github.com/jiuerd/StarRailAssistant/archive/refs/tags/{version}.zip"
    ...
    async def is_sra_latest(self, type: str, version: str, is_log: bool = True):
        ...
        for index, __ in enumerate(range(3)):
            try:
                ...
                up_url = f"{api_proxy}https://api.github.com/repos/jiuerd/StarRailAssistant/releases/latest" if "http" in api_proxy else f"https://api.github.com/repos/jiuerd/StarRailAssistant/releases/latest"
    ...
    async def is_latest(self, type: str, version: str, is_log: bool = True):
        ...
        for index, __ in enumerate(range(3)):
            try:
                url_version = f"{raw_proxy}https://raw.githubusercontent.com/jiuerd/Auto_Star_Rail_MAP/main/version.json" if "http" in raw_proxy or raw_proxy == "" else f"https://raw.githubusercontent.com/jiuerd/StarRailAssistant/{version}/version.json".replace("raw.githubusercontent.com", raw_proxy)
    ...
    async def update_file(self,
        ...
        if type == "star":
            url_list = f"{raw_proxy}https://raw.githubusercontent.com/jiuerd/StarRailAssistant/main/{type}_list.json" if "http" in raw_proxy or raw_proxy == "" else f"https://raw.githubusercontent.com/jiuerd/StarRailAssistant/main/{type}_list.json".replace("raw.githubusercontent.com", raw_proxy)
        else:
            url_list = f"{raw_proxy}https://raw.githubusercontent.com/jiuerd/Auto_Star_Rail_MAP/main/{type}_list.json" if "http" in raw_proxy or raw_proxy == "" else f"https://raw.githubusercontent.com/jiuerd/StarRailAssistant_MAP/main/{type}_list.json".replace("raw.githubusercontent.com", raw_proxy)
